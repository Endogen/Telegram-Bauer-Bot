...
class Bisurlqr(BauerPlugin):
    ...
    def __enter__(self):
        ...
        if not self.table_exists("bisurlqr"):
            sql = self.get_resource("create_bisurlqr.sql")
    ...
    def execute(self, bot, update, args):
        ...
        insert = self.get_resource("insert_bisurlqr.sql")
    ...
    def _callback(self, bot, update):
        ...
        sql = self.get_resource("select_bisurlqr.sql")
